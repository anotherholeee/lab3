/* 1. Для целого числа (char) вывести его дополнительный код.
2. Структура содержит информацию об автомобилях: стоимость (число), марку
(указатель), вложенную структуру – тип кузова (строка фиксированной
длины) и объём двигателя. Найти автомобили со стоимостью больше
заданной. Удалить автомобили заданной марки.

Ройко Артём Андреевич 458302
23 марта 2025 */
